...
from src.infra import fetch_relevant_tables
from src.utils import create_schema_text, save_db_info, load_all_db_info, extract_sql_from_markdown
from src.connectors.pgres import scan_databases, execute_sql_query
from src.llmops import generate_sql_with_ollama, improve_prompt
...
def execute_user_query(query: str):
    ...
    relevant_tables = fetch_relevant_tables(improved_query)
    llm_response = generate_sql_with_ollama(improved_query, relevant_tables, "\n---\n".join(all_schema))
